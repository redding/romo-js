...
// Romo.UI.Spinner extends a DOM element so that it can display a spinner when
// directed. It uses DOM attributes to configure the spinner and uses DOM
// events to interact with the spinner.
//
// Romo.UI.Spinner composes https://spin.js.org/spin.js.
  ...
  return class extends Romo.DOMComponent {
    ...
    doStart({ sizePx, startImmediately } = {}) {
      ...
      if (startImmediately) {
        ...
        this.pushFn(function() { this._startSpinner() })
      }
    ...
    doStop({ stopImmediately } = {}) {
      if (stopImmediately) {
        ...
        this.pushFn(function() { this._stopSpinner() })
      }
