...
Romo.define('Romo.UI.Dropdown.PlacementData', function() {
  return class {
    ...
    get position() {
      return Romo.memoize('position', function() {
    ...
    get align() {
      return Romo.memoize('align', function() {
    ...
    get _availableHeightPx() {
      return Romo.memoize('_availableHeightPx', function() {
    ...
    get _availableWidthPx() {
      return Romo.memoize('_availableWidthPx', function() {
