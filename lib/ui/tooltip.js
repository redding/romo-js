  ...
  return class extends Romo.DOMComponent {
    ...
    _onToggleEnter(e) {
      if (!this.isDisabled) {
        ...
        this._timeout =
          this.delayFn(this.onToggleEnterDelay, function() {
    ...
    _onToggleLeave(e) {
      if (!this.isDisabled) {
        ...
        clearTimeout(this._timeout)
        this._timeout =
          this.delayFn(this.onToggleLeaveDelay, function() {
