...
Romo.define('Romo.UI.Dropdown', function() {
  return class extends Romo.DOMComponent {
    ...
    doUpdatePopoverBodyHTML(contentHTML) {
      this.romoPopover.doUpdateBodyHTML(contentHTML)

      return this
    }

    doUpdatePopoverBodyDOM(contentDOM) {
      this.romoPopover.doUpdateBodyDOM(contentDOM)
