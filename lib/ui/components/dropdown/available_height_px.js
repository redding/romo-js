Romo.define('Romo.UI.Dropdown.AvailableHeightPx', function() {
  return class {
    ...
    get top() {
      return Romo.memoize('top', function() {
        return Math.min(
    ...
    get bottom() {
      return Romo.memoize('bottom', function() {
        return Math.min(
    ...
    get _padTopPx() {
      return Romo.memoize('_padTopPx', function() {
        return this._getPadPx('top')
      })
    }

    get _padBottomPx() {
      return Romo.memoize('_padBottomPx', function() {
        return this._getPadPx('bottom')
      })
    }

    get _maxAvailableHeightPx() {
      return Romo.memoize('_maxAvailableHeightPx', function() {
