  ...
  return class extends Romo.DOMComponent {
    ...
    _bindXHRs() {
      ...
      xhrDOMs.on('Romo.XHR:callStart', Romo.bind(function(e, romoXHR) {
        romoXHR.dom.trigger('Romo.Spinner:triggerStart')
      }, this))
      xhrDOMs.on(
      ...
      xhrDOMs.on('Romo.XHR:callEnd', Romo.bind(function(e, romoXHR) {
        if (romoXHR.dom.is('[data-romo-spinner]')) {
          romoXHR.dom.trigger('Romo.Spinner:triggerStop')
        } else {
          this._pushXHRSuccessData()
        }
      }, this))
      xhrDOMs.on('Romo.Spinner:stopped', Romo.bind(function(e, romoSpinner) {
        this._pushXHRSuccessData()
      }, this))
    }
