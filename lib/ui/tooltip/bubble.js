...
`
    ...
    doOpen() {
      ...
      this.doPlace(Romo.bind(function() {
        if (
          ...
          !this.contentDOM.data('romo-ui-xhr-disabled')
        ) {
    ...
    _bindXHR() {
      ...
      this.contentDOM.setData(
        'romo-ui-xhr-call-url',
        this._romoTooltip.dom.data('romo-ui-tooltip-xhr-call-url')
      )
      this.contentDOM.setData('romo-ui-xhr-call-method', Romo.XMLHttpRequest.GET)
      this.contentDOM.setData('romo-ui-xhr-call-on', 'undefined')
      this.contentDOM.setData(
        'romo-ui-xhr-call-only-once',
        this._romoTooltip.dom.data('romo-ui-tooltip-xhr-call-only-once'),
      )
      this.contentDOM.setData('romo-ui-xhr-disable-with-spinner', true)
      ...
      const xhr = new Romo.UI.XHR(this.contentDOM)
    ...
    _proxyXHREmittedEvents(romoXHR, ...eventNames) {
      ...
      eventNames.forEach(Romo.bind(function(eventName) {
        xhrEventName = `Romo.UI.XHR:${eventName}`
